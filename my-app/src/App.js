...
const members = [
  { id: 1, name: 'ปฐมวงศ์ วงศ์สาลี', nickname: 'บอส', major: 'เทคโนโลยีสารสนเทศ', favorites: ['ชาเขียว', 'แมว'] },
  { id: 2, name: 'ศิวัช จำรูญศิริรุ่งโรจน์', nickname: 'เติ้ล', major: 'เทคโนโลยีสารสนเทศ', favorites: ['ชาเขียว', 'แมว'] },
];
